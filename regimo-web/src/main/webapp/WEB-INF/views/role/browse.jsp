...
<div id="page-content">
<div id="browsePage">
	<h2><spring:message code="title.browse"/><spring:message code="role"/></h2>

	<a href='<s:url value="/role/new"/>'><spring:message code="button.new"/></a>
	...
	<div class="ex_highlight_row">
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			<thead>
				<tr>
					<th width="45%"><spring:message code="role.name"/></th>
					<th width="50%"><spring:message code="role.description"/></th>
