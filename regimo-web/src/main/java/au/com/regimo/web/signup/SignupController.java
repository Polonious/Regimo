...
public class SignupController {
	...
	@Inject private DashletService dashletService;
	...
	public String signup(@Valid UserNewForm form, BindingResult formBinding) {
		...
		Dashlet dashlet = dashletService.findOne(8L);
		ModelMap map = new ModelMap();
		String dashModel = dashlet.getModel();
		if(dashModel!=null){		
				map.addAttribute("user", user);
			}
		String emailBody = TextGenerator.generateText(dashlet.getContent(), map);
